...
class ASR:
    ...
    MODEL_FILE = (
        "SpeD-ParakeetRo_110M_TDT-CTC.nemo"
    )

    def __init__(self) -> None:

        print(
            "Loading SpeD Parakeet Romanian 110M TDT-CTC..."
        )

        # Descarcă modelul din Hugging Face dacă nu există
        # deja în cache.
        ...
        # Încarcă checkpoint-ul .nemo.
        self.model = nemo_asr.models.ASRModel.restore_from(
            restore_path=model_path
        )

        # TIAGo/server-ul nostru rulează pe CPU.
    ...
    def transcribe(self,audio_path: str | Path,language: str = "ro",) -> str:
        ...
        # În funcție de versiunea NeMo, rezultatul poate fi
        # string sau Hypothesis.
        ...
        if not text:
            raise ValueError(
                "SpeD Parakeet returned an empty transcription."
            )
